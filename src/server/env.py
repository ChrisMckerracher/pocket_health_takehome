...
from src.db.dicom.file.dicom_file_repository import DicomFileRepository
...
def create_dev_environment() -> Environment:
    ...
    return Environment(engine=engine, dicom_file_repository=dicom_file_repository, dicom_tag_repository=dicom_tag_repository)
